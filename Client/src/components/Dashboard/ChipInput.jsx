  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <label className="text-sm text-richblack-5" htmlFor={name}>
        Session Ctaegory <sup className="text-pink-200">*</sup>
      </label>
      ...
      <div className="flex w-full flex-wrap gap-y-2">
        ...
        {chips.map((chip, index) => (
          <div
            key={index}
            className="m-1 flex items-center rounded-full bg-yellow-100 px-2 py-1 text-sm text-richblack-5"
          >
        ...
        <input
          ...
          className="form-style w-full bg-richblack-700 p-2"
        />
      </div>
